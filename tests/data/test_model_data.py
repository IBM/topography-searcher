...
def test_initialisation():
    model_data = ModelData(training_file=f'{current_dir}/test_data/training_model1.txt',
                           response_file=f'{current_dir}/test_data/response_model1.txt')
...
def test_unnormalise_response():
    ...
    model_data2 = ModelData(training_file=f'{current_dir}/test_data/training_model1.txt',
                            response_file=f'{current_dir}/test_data/response_model1.txt')
...
def test_unnormalise_response2():
    ...
    model_data.normalise_response()
    model_data.unnormalise_response()
    model_data2 = ModelData(training_file=f'{current_dir}/test_data/training_model2.txt',
                            response_file=f'{current_dir}/test_data/response_model2.txt')
    assert np.all(model_data.training == pytest.approx(model_data2.training))
    assert np.all(model_data.response == pytest.approx(model_data2.response))
...
def test_feature_subset():
    model_data = ModelData(training_file=f'{current_dir}/test_data/training_model3.txt',
                           response_file=f'{current_dir}/test_data/response_model3.txt')
    features = [0, 2, 4]
