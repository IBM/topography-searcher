...
pot_file = '/dccstor/chemistry_ai/mlp_landscapes/models/allegro/paracetamol/allegro_paracetamol.pt'
mlp = MachineLearningPotential(species, 'nequip', pot_file, 'cuda')
ff = MMFF94(atfile)
...
explorer.get_minima(coords=coords,
                    ...
                    temperature=100.0,
                    test_valid=True)
ktn.dump_network('.first') # checkpoint
