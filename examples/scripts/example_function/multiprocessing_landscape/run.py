...
def main():
    ...
    explorer_serial = NetworkSampling(ktn=ktn,
                                    coords=coords,
    ...
    # other local minima
    explorer_serial.get_minima(coords=coords,
                            n_steps=1000,
                            conv_crit=1e-5,
                            temperature=100.0,
                            test_valid=True)
    # Then get the transition states between them
    explorer_serial.get_transition_states(method='ClosestEnumeration',
                                        cycles=8,
    ...
    explorer_parallel.get_minima(coords=coords,
                                n_steps=1000,
                                conv_crit=1e-5,
                                temperature=100.0,
                                test_valid=True)
